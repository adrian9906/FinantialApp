...
/**
 * Income accounts can be created in a currency the user has never opened the
 * settings screen to register. Without persisting it as a preference, the code
 * only lives in this browser's account row and any other device falls back to
 * USD, silently converting the account. Registering it here keeps the account's
