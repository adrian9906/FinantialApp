...
const schemas = {
  ...
  wishlist: z.object({ id, name: text, price: amount, priority: z.enum(['low', 'medium', 'high']), savedAmount: amount, externalContribution: amount.optional(), isPurchased: z.boolean().optional(), purchasedAt: date.optional(), image: hostedImageUrl.optional(), sourceStore: text.optional(), sourceUrl: text.optional(), sourceCurrency: text.optional() }),
