...
export default function ExpensesScreen() {
  ...
  const inlineAmountError = useMemo(() => {
    ...
    if (parsedAmount > availableToPlan || plannedTotal + parsedAmount > overview.budgetExpenses) {
      return `No puedes agregarlo porque supera el limite disponible de ${formatMoney(availableToPlan)}.`
    }
    return null
  }, [availableToPlan, form.amount, overview.budgetExpenses, parsedAmount, plannedTotal])
